...
def saveImage(settings, width, height, quality, diskSpaceToReserve):
    ...
    print "We can trigger some events here."
...
#callback method to handle recieved messages
def on_message(client, userdata, message):
        ...
        if(str(message.payload.decode("utf-8")) == "FLASH"):
                print("Turned LED ON")
        ...
        if(str(message.payload.decode("utf-8")) == "DELAY"):
                GPIO.output(2,GPIO.HIGH)
                time.sleep(15)
                GPIO.output(2,GPIO.LOW)
	else:
...
broker_address = raw_input("Enter the MQTT broker IP: ")
topic = raw_input("Please enter the MQTT Topic: ")
message = raw_input("Please enter your MQTT message: ")
